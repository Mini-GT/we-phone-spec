...
import { formatNumberToCompact } from '~/lib/formatNumber';
...
export default function mostPopular() {
  ...
  return (
    <div className='flex gap-4 mx-15 my-4 bg-[#F8F9FA]'>
      <div className="relative">
        ...
        <ul className="mb-4 grid grid-cols-[230px_230px_230px_230px_230px] gap-4 rounded">
          {currentItems.map(item => (
            <div key={item.id} className="flex flex-col justify-between items-start max-w-[15rem] cursor-pointer">
              <div className="relative">
      ...
      <div className='w-full'>
        <h1 className="text-xl font-bold mb-4">Top 10</h1>
      </div>
    </div>
  );
}
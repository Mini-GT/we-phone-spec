...
export async function action({request}: ActionFunctionArgs) {
  ...
  if(parsedPagination) {
    const data = await queryClient.fetchQuery({
      ...
      queryFn: async () => await smartphoneService.getTopAllTimeViewedSmartphones(parsedPagination.skip, parsedPagination.take)
    })
    result = data
  }
...
export default function MostViewed() {
  ...
  const smartphones = fetcher.data?.result.topViewed

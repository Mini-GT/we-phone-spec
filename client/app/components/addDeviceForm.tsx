...
type FormPath = 
  ...
  | 'specs.sound.jack.hasJackSlot'
  | 'specs.sound.jack.jackFeatures'
...
export default function AddDeviceForm() {
  const [formData, setFormData] = useState<Omit<Smartphone, "id" | "image">>({
    name: '',
    brand: '',
    views: 0,
    likes: 0,
  ...
  return (
    <div className="relative rounded-xl h-[90vh] overflow-y-scroll">
      <div className="relative rounded-t-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center space-x-3">
                      <input
                        type="checkbox"
                        checked={formData.specs.memory.cardSlot}
                        onChange={(e) => handleInputChange('specs.memory.cardSlot', e.target.checked)}
                        className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <label className="text-sm font-medium text-gray-700">Has Card Slot</label>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">3.5mm Jack *</label>
                      <div className="flex items-center space-x-3">
                        <div className="flex items-center space-x-3">
                          <input
                            type="checkbox"
                            checked={formData.specs.sound.jack.hasJackSlot}
                            onChange={(e) => handleInputChange('specs.sound.jack.hasJackSlot', e.target.checked)}
                            className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                          />
                          <label className="text-sm text-nowrap font-medium text-gray-700">Has 3.5mm slot</label>
                        </div>
                        
                        <input
                          type="text"
                          value={formData.specs.sound.jack.jackFeatures}
                          onChange={(e) => handleInputChange('specs.sound.jack.jackFeatures', e.target.value)}
                          placeholder="e.g., 24-bit/192kHz Hi-Res"
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        />
                      </div>
